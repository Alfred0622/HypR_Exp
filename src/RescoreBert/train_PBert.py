...
log_path = f"./log/P_BERT/{args['dataset']}/{setting}"
run_name = f"batch{train_args['batch_size']}_lr{train_args['lr']}_Freeze{train_args['freeze_epoch']}_{train_args['epoch']}epochs_Reduction{train_args['reduction']}"
...
log_path = Path(f"./log/RescoreBERT/{args['dataset']}/{setting}")
...
checkpoint_path = Path(
    f"./checkpoint/{args['dataset']}/NBestCrossBert/{setting}/{args['nbest']}best/{run_name}"
)
