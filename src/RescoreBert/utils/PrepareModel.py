...
support_dataset = ["aishell", "aishell2", "tedlium2", "librispeech", "csj", 'AISHELL1', 'TEDLIUM2', 'LibriSpeech']
...
def prepare_GPT2(dataset, device):
    ...
    if dataset in ["tedlium2", "librispeech", "tedlium2_conformer", "TEDLIUM2","LibriSpeech"]:
