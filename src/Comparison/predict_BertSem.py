...
for checkpoint_path in checkpoint_paths:
    ...
    for task in recog_set:
        ...
        if (args['dataset'] in ['librispeech', 'LibriSpeech'] and task == 'valid'):
        ...
        with open(file_name) as f:
            ...
            data_json = load_dataset(f"ASR-HypR/{args['dataset']}_{setting}", split = f'{task}') # Use same variable to avoid memeory exceed
